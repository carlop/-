...
def place_entities(room, entities, dungeon_level, colors):
    ...
    number_of_monters = randint(0, max_monsters_per_room)
    ...
    item_chances = {
        'healing_potion'  : 70,
        'lightning_scrool': from_dungeon_level([[25, 4]], dungeon_level),
    ...
    for i in range(number_of_items):
        ...
        if not any([entity for entity in entities if entity.x == x and entity.y == y]):
            ...
            if item_choice == 'healing_potion':
                ...
                item_component = Item(use_function=cast_fireball, targeting=True, targeting_message=Message('Left-click a target tile for the fireball, or right-click to cancel', colors.get('light_cyan')), damage=25, radius=3)
